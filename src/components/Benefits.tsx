  ...
  return (
    <section id="about" className="py-16 md:py-24 bg-gradient-to-b from-white to-blue-50">
      <div className="container mx-auto px-4 md:px-8 space-y-16">
        ...
        <section className="relative bg-gradient-to-br from-blue-50 via-white to-blue-100 py-20 px-6 md:px-12 overflow-hidden">
          {/* Trending Background Decorations: Subtle Blobs for Depth */}
          ...
          <div className="text-center max-w-5xl mx-auto space-y-8 relative z-10">
            ...
            <div className="flex flex-col items-center space-y-3">
              ...
              <p className="text-gray-700 text-base md:text-lg max-w-3xl leading-relaxed bg-white/70 backdrop-blur-sm rounded-2xl p-4 md:p-6 border border-blue-100/50 shadow-md">
                Key Lanka Solutions (Pvt) Ltd is a professional security and safety solutions provider committed to 
                delivering reliable, efficient, and innovative services. Managed by experienced ex-army officers, 
                our leadership brings decades of operational expertise, discipline, and integrity to every project.
              </p>
            </div>
              ...
              <div className="group relative bg-white/90 backdrop-blur-md rounded-2xl shadow-xl p-8 hover:shadow-2xl hover:scale-105 transition-all duration-300 border border-blue-100 overflow-hidden">
                ...
                <div className="flex items-center gap-4 mb-4 relative z-10">
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 w-8 h-8 rounded-full bg-blue-700/20 blur-xl animate-ping group-hover:bg-blue-600/30"></div>
                  </div>
                ...
                <p className="text-gray-700 text-base leading-relaxed relative z-10">
                  To be the most trusted and innovative security and safety solutions provider in Sri Lanka, 
                  setting new standards in professionalism, reliability, and client satisfaction.
                </p>
              </div>
              ...
              <div className="group relative bg-white/90 backdrop-blur-md rounded-2xl shadow-xl p-8 hover:shadow-2xl hover:scale-105 transition-all duration-300 border border-blue-100 overflow-hidden">
                ...
                <div className="flex items-center gap-4 mb-4 relative z-10">
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 w-8 h-8 rounded-full bg-blue-700/20 blur-xl animate-ping group-hover:bg-blue-600/30 delay-300"></div>
                  </div>
                  <h3 className="text-2xl font-semibold bg-gradient-to-r from-blue-900 to-blue-700 bg-clip-text text-transparent">
                    Our Mission
                  </h3>
                ...
                <p className="text-gray-700 text-base leading-relaxed relative z-10">
                  To deliver effective, efficient, and customized security and fire-safety solutions through 
                  disciplined operations, well-trained personnel, and cutting-edge technology — ensuring the 
        ...
        {/* Existing Image + Benefits with Modern Style */}
          ...
          <div className="w-full md:w-1/2 mt-10 md:mt-0 space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4 md:gap-6">
              {benefits.map((benefit, index) => (
                ...
                >
                  <div className="bg-gradient-to-br from-blue-500 to-blue-600 p-3 rounded-xl text-white flex-shrink-0 transition-transform group-hover:scale-110">
                    {benefit.icon}
                  </div>
                  <div>
                    <h3 className="text-lg md:text-xl font-semibold text-blue-900 mb-1">{benefit.title}</h3>
            ...
            <div className="mt-8 md:mt-10">
              <a
                href="#contact"
                className="bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white px-6 py-3 md:px-8 md:py-4 rounded-full font-medium inline-flex items-center justify-center shadow-md hover:shadow-lg transition-transform hover:scale-105 active:scale-95"
              >
