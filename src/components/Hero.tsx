...
import { ShieldCheckIcon, LockIcon, EyeIcon, PhoneIcon, MailIcon } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description:
        'Carefully selected, trained, and background-verified security personnel with military discipline.',
    },
    {
      icon: <LockIcon className="h-5 w-5 sm:h-6 sm:w-6 text-blue-300" />,
      title: 'Comprehensive Solutions',
      description:
        'Full spectrum of security and fire-safety services for individuals, corporates, and institutions.',
    },
    {
      icon: <EyeIcon className="h-5 w-5 sm:h-6 sm:w-6 text-blue-300" />,
      title: '24/7 Availability',
      description:
        'Rapid response capability and continuous monitoring to ensure your safety around the clock.',
    },
  ];
    ...
    >
      ...
      <div className="relative z-30 flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            We are committed to safeguarding your life, property, and business eith trusted security solutions, ensuring safety, reliability, and peace of mind around the clock.
          </motion.p>
